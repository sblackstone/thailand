...
trip = {
 ...
 4:('cnx','Chiang Mai · arr 07:15','Old City temples · khao soi','',''),
 5:('cnx','Chiang Mai','Elephant sanctuary day','',''),
 6:('cnx','Chiang Mai','Doi Suthep · cooking class','',''),
 7:('krb','Fly CNX → KBV','Chiang Mai → Krabi · Ao Nang','plane','s-cnx-krb'),
 8:('krb','Krabi','Island-hop: Hong or 4-Islands','',''),
 9:('krb','Krabi','Tiger Cave / Emerald Pool','',''),
